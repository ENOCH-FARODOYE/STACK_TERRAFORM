...
environment_config = {
  ...
  dev_account_id        = "451873237827"  # Could be different automation account
  project_name          = "clixx"
...
# ========================================
network_config = {
  vpc_cidr              = "10.2.0.0/16"  # Different CIDR for automation
...
# ========================================
compute_config = {
  instance_type              = "t3.small"  # Bigger for automation
...
# ========================================
database_config = {
  identifier              = "clixx-automation-db"
  snapshot_identifier     = "clixx-db-final-snapshot"
  instance_class          = "db.t3.small"  # Bigger for automation
  engine                  = "mysql"
  storage_type            = "gp3"
...
# ========================================
efs_config = {
  creation_token        = "clixx-automation-efs-v2"
  encrypted             = true
...
route53_config = {
  ...
  record_name            = "automation.clixx.enoch-stack.com"
