...
The primary application infrastructure featuring a 12-subnet VPC design:

**Network Architecture:**
- 12 subnets across 2 availability zones (us-east-1a, us-east-1b)
- 4 public subnets for load balancers and NAT gateways
- 4 private subnets for application tier
- 4 private subnets for data tier (RDS)
